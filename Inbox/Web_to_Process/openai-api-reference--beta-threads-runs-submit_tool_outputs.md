---
source_url: https://developers.openai.com/api/reference/resources/beta/subresources/threads/subresources/runs/methods/submit_tool_outputs
...
[](#(resource)%20beta.threads.runs%20%3E%20(method)%20submit_tool_outputs%20%3E%20(params)%20default.non_streaming%20%3E%20(param)%20thread_id%20%3E%20(schema))

run_id : string

[](#(resource)%20beta.threads.runs%20%3E%20(method)%20submit_tool_outputs%20%3E%20(params)%20default.non_streaming%20%3E%20(param)%20run_id%20%3E%20(schema))
...
[](#(resource)%20beta.threads.runs%20%3E%20(method)%20submit_tool_outputs%20%3E%20(params)%200.non_streaming%20%3E%20(param)%20tool_outputs%20%3E%20(schema)%20%3E%20(items)%20%3E%20(property)%20output)

tool_call_id : optional string

The ID of the tool call in the `required_action` object within the run object the output is being submitted for.

[](#(resource)%20beta.threads.runs%20%3E%20(method)%20submit_tool_outputs%20%3E%20(params)%200.non_streaming%20%3E%20(param)%20tool_outputs%20%3E%20(schema)%20%3E%20(items)%20%3E%20(property)%20tool_call_id)

[](#(resource)%20beta.threads.runs%20%3E%20(method)%20submit_tool_outputs%20%3E%20(params)%200.non_streaming%20%3E%20(param)%20tool_outputs%20%3E%20(schema))

stream : optional boolean

If `true`, returns a stream of events that happen during the Run as server-sent events, terminating when the Run enters a terminal state with a `data: [DONE]` message.

[](#(resource)%20beta.threads.runs%20%3E%20(method)%20submit_tool_outputs%20%3E%20(params)%200.non_streaming%20%3E%20(param)%20stream%20%3E%20(schema))
