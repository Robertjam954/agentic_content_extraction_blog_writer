---
source_url: https://developers.openai.com/api/reference/resources/projects/subresources/users/subresources/roles/methods/list
title: "List project user role assignments"
scraped: 2026-07-24
type: doc
...
[](#(resource)%20admin.organization.projects.users.roles%20%3E%20(method)%20list%20%3E%20(params)%20default%20%3E%20(param)%20project_id%20%3E%20(schema))

user_id : string

[](#(resource)%20admin.organization.projects.users.roles%20%3E%20(method)%20list%20%3E%20(params)%20default%20%3E%20(param)%20user_id%20%3E%20(schema))
...
[](#(resource)%20admin.organization.projects.users.roles%20%3E%20(method)%20list%20%3E%20(params)%20default%20%3E%20(param)%20after%20%3E%20(schema))
...
[](#(resource)%20admin.organization.projects.users.roles%20%3E%20(method)%20list%20%3E%20(params)%20default%20%3E%20(param)%20limit%20%3E%20(schema))
...
[](#(resource)%20admin.organization.projects.users.roles%20%3E%20(method)%20list%20%3E%20(params)%20default%20%3E%20(param)%20order%20%3E%20(schema)%20%3E%20(member)%200)

"desc"

[](#(resource)%20admin.organization.projects.users.roles%20%3E%20(method)%20list%20%3E%20(params)%20default%20%3E%20(param)%20order%20%3E%20(schema)%20%3E%20(member)%201)

[](#(resource)%20admin.organization.projects.users.roles%20%3E%20(method)%20list%20%3E%20(params)%20default%20%3E%20(param)%20order%20%3E%20(schema))
...
[](#(resource)%20admin.organization.projects.users.roles%20%3E%20(method)%20list%20%3E%20(network%20schema)%20%3E%20(property)%20data)

has_more : boolean

Whether additional assignments are available when paginating.

[](#(resource)%20admin.organization.projects.users.roles%20%3E%20(method)%20list%20%3E%20(network%20schema)%20%3E%20(property)%20has_more)

next : string

Cursor to fetch the next page of results, or `null` when there are no more assignments.

[](#(resource)%20admin.organization.projects.users.roles%20%3E%20(method)%20list%20%3E%20(network%20schema)%20%3E%20(property)%20next)

object : "list"

Always `list`.

[](#(resource)%20admin.organization.projects.users.roles%20%3E%20(method)%20list%20%3E%20(network%20schema)%20%3E%20(property)%20object)
...
---
Source: https://developers.openai.com/api/reference/resources/projects/subresources/users/subresources/roles/methods/list
