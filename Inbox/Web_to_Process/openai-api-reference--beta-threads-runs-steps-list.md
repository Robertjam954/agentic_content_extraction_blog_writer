---
source_url: https://developers.openai.com/api/reference/resources/beta/subresources/threads/subresources/runs/subresources/steps/methods/list
...
[](#(resource)%20beta.threads.runs.steps%20%3E%20(method)%20list%20%3E%20(params)%20default%20%3E%20(param)%20thread_id%20%3E%20(schema))

run_id : string

[](#(resource)%20beta.threads.runs.steps%20%3E%20(method)%20list%20%3E%20(params)%20default%20%3E%20(param)%20run_id%20%3E%20(schema))
...
[](#(resource)%20beta.threads.runs.steps%20%3E%20(method)%20list%20%3E%20(params)%20default%20%3E%20(param)%20after%20%3E%20(schema))

before : optional string

A cursor for use in pagination. `before` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with obj_foo, your subsequent call can include before=obj_foo in order to fetch the previous page of the list.

[](#(resource)%20beta.threads.runs.steps%20%3E%20(method)%20list%20%3E%20(params)%20default%20%3E%20(param)%20before%20%3E%20(schema))
...
[](#(resource)%20beta.threads.runs.steps%20%3E%20(method)%20list%20%3E%20(params)%20default%20%3E%20(param)%20include%20%3E%20(schema))

limit : optional number

A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 20.

[](#(resource)%20beta.threads.runs.steps%20%3E%20(method)%20list%20%3E%20(params)%20default%20%3E%20(param)%20limit%20%3E%20(schema))
...
[](#(resource)%20beta.threads.runs.steps%20%3E%20(method)%20list%20%3E%20(params)%20default%20%3E%20(param)%20order%20%3E%20(schema)%20%3E%20(member)%200)

"desc"

[](#(resource)%20beta.threads.runs.steps%20%3E%20(method)%20list%20%3E%20(params)%20default%20%3E%20(param)%20order%20%3E%20(schema)%20%3E%20(member)%201)

[](#(resource)%20beta.threads.runs.steps%20%3E%20(method)%20list%20%3E%20(params)%20default%20%3E%20(param)%20order%20%3E%20(schema))

##### Returns Expand Collapse

data : array of [RunStep](/api/reference/resources/beta#(resource)%20beta.threads.runs.steps%20%3E%20(model)%20run_step%20%3E%20(schema)) { id , assistant_id , cancelled_at , 13 more }
...
[](#(resource)%20beta.threads.runs.steps%20%3E%20(method)%20list%20%3E%20(network%20schema)%20%3E%20(property)%20data)

first_id : string

[](#(resource)%20beta.threads.runs.steps%20%3E%20(method)%20list%20%3E%20(network%20schema)%20%3E%20(property)%20first_id)

has_more : boolean

[](#(resource)%20beta.threads.runs.steps%20%3E%20(method)%20list%20%3E%20(network%20schema)%20%3E%20(property)%20has_more)

last_id : string

[](#(resource)%20beta.threads.runs.steps%20%3E%20(method)%20list%20%3E%20(network%20schema)%20%3E%20(property)%20last_id)

object : string

[](#(resource)%20beta.threads.runs.steps%20%3E%20(method)%20list%20%3E%20(network%20schema)%20%3E%20(property)%20object)
