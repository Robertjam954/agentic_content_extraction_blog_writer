---
source_url: https://developers.openai.com/api/reference/resources/vector_stores/subresources/file_batches/methods/list_files
...
[](#(resource)%20vector_stores.file_batches%20%3E%20(method)%20list_files%20%3E%20(params)%20default%20%3E%20(param)%20vector_store_id%20%3E%20(schema))

batch_id : string

[](#(resource)%20vector_stores.file_batches%20%3E%20(method)%20list_files%20%3E%20(params)%20default%20%3E%20(param)%20batch_id%20%3E%20(schema))
...
[](#(resource)%20vector_stores.file_batches%20%3E%20(method)%20list_files%20%3E%20(params)%20default%20%3E%20(param)%20after%20%3E%20(schema))

before : optional string

A cursor for use in pagination. `before` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with obj_foo, your subsequent call can include before=obj_foo in order to fetch the previous page of the list.

[](#(resource)%20vector_stores.file_batches%20%3E%20(method)%20list_files%20%3E%20(params)%20default%20%3E%20(param)%20before%20%3E%20(schema))
...
[](#(resource)%20vector_stores.file_batches%20%3E%20(method)%20list_files%20%3E%20(params)%20default%20%3E%20(param)%20filter%20%3E%20(schema)%20%3E%20(member)%200)

"completed"

[](#(resource)%20vector_stores.file_batches%20%3E%20(method)%20list_files%20%3E%20(params)%20default%20%3E%20(param)%20filter%20%3E%20(schema)%20%3E%20(member)%201)

"failed"

[](#(resource)%20vector_stores.file_batches%20%3E%20(method)%20list_files%20%3E%20(params)%20default%20%3E%20(param)%20filter%20%3E%20(schema)%20%3E%20(member)%202)

"cancelled"

[](#(resource)%20vector_stores.file_batches%20%3E%20(method)%20list_files%20%3E%20(params)%20default%20%3E%20(param)%20filter%20%3E%20(schema)%20%3E%20(member)%203)

[](#(resource)%20vector_stores.file_batches%20%3E%20(method)%20list_files%20%3E%20(params)%20default%20%3E%20(param)%20filter%20%3E%20(schema))

limit : optional number

A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 20.

[](#(resource)%20vector_stores.file_batches%20%3E%20(method)%20list_files%20%3E%20(params)%20default%20%3E%20(param)%20limit%20%3E%20(schema))
...
[](#(resource)%20vector_stores.file_batches%20%3E%20(method)%20list_files%20%3E%20(params)%20default%20%3E%20(param)%20order%20%3E%20(schema)%20%3E%20(member)%200)

"desc"

[](#(resource)%20vector_stores.file_batches%20%3E%20(method)%20list_files%20%3E%20(params)%20default%20%3E%20(param)%20order%20%3E%20(schema)%20%3E%20(member)%201)

[](#(resource)%20vector_stores.file_batches%20%3E%20(method)%20list_files%20%3E%20(params)%20default%20%3E%20(param)%20order%20%3E%20(schema))
...
[](#(resource)%20vector_stores.file_batches%20%3E%20(method)%20list_files%20%3E%20(network%20schema)%20%3E%20(property)%20data)

first_id : string

[](#(resource)%20vector_stores.file_batches%20%3E%20(method)%20list_files%20%3E%20(network%20schema)%20%3E%20(property)%20first_id)

has_more : boolean

[](#(resource)%20vector_stores.file_batches%20%3E%20(method)%20list_files%20%3E%20(network%20schema)%20%3E%20(property)%20has_more)

last_id : string

[](#(resource)%20vector_stores.file_batches%20%3E%20(method)%20list_files%20%3E%20(network%20schema)%20%3E%20(property)%20last_id)

object : string

[](#(resource)%20vector_stores.file_batches%20%3E%20(method)%20list_files%20%3E%20(network%20schema)%20%3E%20(property)%20object)
